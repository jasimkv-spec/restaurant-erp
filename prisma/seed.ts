...
async function main() {
  ...
  const CRUD_SCREENS = [
    ...
    "Masters.Area", "Masters.PaymentMethod", "Masters.Tax", "Masters.Term", "Masters.Uom",
    "Procurement.Vendor",
  ...
  const CUSTOM_PERMISSIONS = [
    ...
    "Inventory.ItemGlMapping.Create", "Inventory.Item.ViewCost", "Inventory.StockBalance.View", "Inventory.StockLedger.View",
    ...
    "Masters.Currency.Create", "Masters.Currency.View", "Masters.UomConversion.Create", "Masters.UomConversion.View",
    ...
    "Procurement.MaterialRequest.Approve", "Procurement.MaterialRequest.Create", "Procurement.MaterialRequest.Submit", "Procurement.MaterialRequest.View",
